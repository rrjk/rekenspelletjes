...
import { renderFractionsPairMatchingGameHourglassGameIcon } from './FractionsPairMatchingGameHourglassGameIcon';
...
/**
 * Variant index app for Fractions Pair Matching Game.
 *
...
export class FractionsPairMatchingGameIndexApp extends VariantIndexAppBase<IndexPage> {
  ...
  protected get iconRenderer() {
    return renderFractionsPairMatchingGameHourglassGameIcon;
  }
